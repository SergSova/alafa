...
class alcaptcha {
    ...
    var $session_key_feed= 'alcode_feed_iuhxfhjuxf467xfhubjHB';
                       // Put here some random string
                       // Подставьте какую-нибудь случайную строку.   
//**************************************************************************************                                                   
...
//**************************************************************************************  
//**************************************************************************************    
    function check_feed($code){
        $CI =& get_instance();
        if ($CI->session->userdata($this->session_key_feed)== $code) {
            return true;
        } else {
            return false;
        }
...
//**************************************************************************************    
	...
	$CI->session->set_userdata($this->session_key,$char);
        ...
        //$color = imagecolorallocate ($im1, 250, 100, 0);
         //  15, 0, 78
        $color = imagecolorallocate ($im1, 250, 100, 0);
        //$color = imagecolorallocate ($im1, 38, 26, 64); 
 ...
 //**************************************************************************************    
    ...
    $im1 = imagecreatetruecolor ($width, $height) or die ("Cannot initialize new GD image stream!");
        ...
        $CI =& get_instance();
    $CI->session->set_userdata($this->session_key_feed,$char);
