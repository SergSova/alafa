...
<table class="uchet" align="center" cellpadding="0" cellspacing="0">
 <tr> <td colspan="2">РЕДАКТИРОВАНИЕ ИНФОРМАЦИИ УЧЕТНОЙ ЗАПИСИ</td> </tr>
                    ...
                    <tr>
                    	<td>Банк, где выдана карта </td>
                        <td><?php if(empty($user_info['bank'])) { ?><input name="bank" type="text"  value="<?php  print ($user_info['bank']);?>" size="40" placeholder=""  required /><?php } else { echo $user_info['bank'] ;}?></td>
                    </tr>
                    <tr>
                    	<td>МФО банка</td>
                        <td><?php if(empty($user_info['bank_mfo'])) { ?><input name="bank_mfo" type="text"  value="<?php  print ($user_info['bank_mfo']);?>" size="40" placeholder=""  required /><?php } else { echo $user_info['bank_mfo'] ;}?></td>
                    </tr>
                    <tr>
                    	<td>ОКПО банка</td>
                        <td><?php if(empty($user_info['bank_okpo'])) { ?><input name="bank_okpo" type="text"  value="<?php  print ($user_info['bank_okpo']);?>" size="40" placeholder=""  required /><?php } else { echo $user_info['bank_okpo'] ;}?></td>
                    </tr>
                    <tr>
                    	<td>Номер банковской карты </td>
                        <td><?php if(empty($user_info['bank_card'])) { ?><input name="bank_card" type="text"  value="<?php  print ($user_info['bank_card']);?>" size="40" placeholder=""  required /><?php } else { echo $user_info['bank_card'] ;}?></td>
                    </tr>
