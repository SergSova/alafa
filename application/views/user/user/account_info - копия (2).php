 ...
 <div id="referals"  class="adm_tab_block">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="full_info_tbl" align="center">
    <tbody>
	  ...
	  if($key_w < 10){
		  if($count_1refs_levels[$key_w]> 0 && $count_1refs_levels[$key_w]>=5) {  // $count_1refs_levels[$key_w] % 5 == 0)
			...
			// if(in_array($key_w , $main_levels_me)) {
				  ...
				  /* } else {
				  $count_cantake_1  = ' <span class="tmk_nop">Откройте данный этап для получения коммиссии</span> '; 
				  }*/
		  ...
		  if($count_2refs_levels[$key_w]> 0 && $count_2refs_levels[$key_w] >=5) {  //  % 5 == 0
			...
			/*  } else {
				  $count_cantake_2  = ' <span class="tmk_nop">Откройте данный этап для получения коммиссии</span> '; 
				  }*/
			  // echo " | кол-во комиссий ".$count_cantake_3;
		  ...
		  if($count_3refs_levels[$key_w]> 0 && $count_3refs_levels[$key_w] >=5) { //  % 5 == 0
 ...
 $('.tmk_ch').on("click", function () {
	 ...
	 $.ajax({  
							...
							var response_obj = $.parseJSON(response);
									...
									console.log("lqsignature = "+response_obj.lqsignature) ;
									console.log("d_t = "+response_obj.d_t) ;
									console.log("d_kq = "+response_obj.d_kq) ;
									console.log("d_kq = "+response_obj.d_kq) ;
									setTimeout(function(){ 
