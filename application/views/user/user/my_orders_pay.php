...
<div class="m_howit"> <p class="big">История счетов и транзакций<!--<?=lang('main_user_your_partner_progr')?>--></p>
...
<div > 
  <table class="refer" cellpadding="0" cellspacing="0" width="100%" >
    <tr>
      <td colspan="4"><p align="center">Сформированные счета</p></td>
      <td colspan="2"> 
    ...
    <tr>
      ...
      <td class="header_td" width="25%">Стоимость, валюта<!--price ac_merchant_currency--></td> 
    ...
    <tr>
      ...
      <td><?=$my_order['price']?> <?=$my_order['ac_merchant_currency']?></td> 
