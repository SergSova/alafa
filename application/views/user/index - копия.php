...
<div id="global">
	<div class="top">
    	<div class="m_top">
        <div class="db_project">Проект "Даждьбог"</div>
<div class="language">
...
<div class="m_header"> 
      <div class="logo"><a href="/<?=lang('main_lang')?>"><img src="/media/css/user/img/alafa.jpg" height="80" /> <span class="logo_h">АЛАФА</span></a></div> 
            <div class="count">
            	<span><?=lang('main_user_qty_reged_users')?>:</span>
                <div class="people" id="people_counter"> </div>
            </div><!--count-->
            <div class="logo_fond"><noindex><img src="/media/css/user/img/logo_fond_md_<?=lang('main_lang')?>.png" height="70" /></noindex></div>
...
<div class="red <?php // if(isset($index)) { echo " red_short ";  } ?>">
    	<div class="m_red">
...
<?php } ?>
 ...
 <div class="fl"> <?=lang('main_user_all_rights_res')?>
