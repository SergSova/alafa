...
<div align="center" class="feed_form">
 <form  method="post" action="<?php echo base_url();?><?=lang('main_lang')?>/page/partners_feed/" enctype="multipart/form-data" name="myformpartners" id="myformpartners">
  <table cellpadding="0" cellspacing="0" class="form" align="center">
    <tr>
      <td width="220" valign="middle" ><?=lang('main_feed_form_name')?>*</td>
      <td valign="middle"><input name="fio" type="text" value="" size="40" required  /></td>
      </tr>
    <tr>
      <td  valign="middle"> <?=lang('main_feed_form_phone')?></td>
      <td  valign="middle"  > 
        <input name="phone" type="text" value="" size="40" required />
        </td>
    </tr>
    <tr>
      <td  valign="middle"><?=lang('main_feed_form_email')?>*</td>
      <td  valign="middle"  ><input name="email" type="text" value="" size="40" required />
 </td>
      </tr>
       <tr>
      <td valign="middle"><?=lang('main_feed_form_company')?></td>
      <td valign="middle"  >
      <input name="company"  type="text" value="" size="40" required />
      </td>
      </tr>
    <tr>
     ...
     <tr>
      ...
      <div id="sendfeedbutton">
        <input name="btn" class="styled_button" type="submit" value="<?=lang('main_feed_form_send_partners_feed')?>" />
      </div>
       </td>
        </tr>
