<div>
  <div align="center" class="td-caption-top" style="padding-top:10px;"> Форма редактирования адресов блокировки доступа на форум</div>


</div>
<?php $ban_list = explode(",", $ban_list_forum);
//print_r($ban_list);
?>
<fieldset>
      	<legend>
      ...
      <form  method="post" action="<?php echo base_url();?>manage_ban/edit_forum_ban/" enctype="multipart/form-data"    name="myform" id="myform">
<div>
