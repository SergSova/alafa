      ...
      <table width="90%" border="0" cellpadding="0" cellspacing="0" align="center" class="listtable">
         <tr>
          ...
          <td class="column"><div align="left">
            <input name="inn" type="text"  value="<?php  print ($ui['inn']);?>" size="40"/>      
            </div></td>
        </tr>
        <tr>
 ...
 <select name="birthday_day">
      ...
      <tr>
          ...
          <td class="column"> 
            Страна 
          <div align="left">
            <input name="country" type="text"  value="<?=$ui['country']?>" size="40"/>      
          </div>
           Город
          <div align="left">
            <input name="town" type="text"  value="<?=$ui['town']?>" size="40"/>      
          </div>
	...
	<div align="left">
      <textarea  name="adres" cols="30" rows="2"><?php  if(isset($ui['u_adres'])) echo $ui['u_adres'];?></textarea>
         ...
         <tr>
          ...
          <td class="column"><div align="left">
            <input name="adv_uid" type="text"  value="<?=$ui['adv_uid']?>" size="40"/>      
          </div></td>
        </tr>
       <!-- <tr>
          ...
          <td class="column"> 
           Банк 
          <div align="left">
            <input name="bank" type="text"  value="<?=$ui['bank']?>" size="40"/>      
          </div>
           Банк МФО
          <div align="left">
            <input name="bank_mfo" type="text"  value="<?=$ui['bank_mfo']?>" size="40"/>      
          </div> 
          Банк ОКПО 
          <div align="left">
            <input name="bank_okpo" type="text"  value="<?=$ui['bank_okpo']?>" size="40"/>      
          </div>
          Номер карточки банка 
          <div align="left">
            <input name="bank_card" type="text"  value="<?=$ui['bank_card']?>" size="40"/>      
          </div>
          </td>
        </tr>  --> 
