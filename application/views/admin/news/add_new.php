...
<form id="form1" name="form1" method="post" action="<?php echo base_url();?>manage_news/add_new_done/" enctype="multipart/form-data">
<div class="td-caption-top"> Добавить новость  на дату <input type="text" value="<?=date("Y-m-d")?>" name="date" id="date_input1"  /> <span style="color:#903; font-size:10px;">Формат даты ГГГГ-мм-дд</span>    
</div>
