...
<div>
  <div class="td-caption-top">Редактирование новости </div>
  <?php
  ...
  <form id="form1" name="form1" method="post" action="<?php echo base_url();?>manage_news/edit_new_done/" enctype="multipart/form-data">
    
    <div class="td-caption" style="margin-top:10px; padding-top:5px;"><strong>Дата новости </strong><input type="text" name="ed_date" id="date_input1" value="<?php  print ($a['date']);?>"  /> <span style="color:#903; font-size:10px;">Формат даты ГГГГ-мм-дд</span>    </div>
