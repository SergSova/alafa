<div class="td-caption-top">Редактирование шаблона письма  
  <?php
...
<form id="form1" name="form1" method="post" action="<?php echo base_url();?>manage_letter_templ/edit_letter_templ_done/">
<div align="left">
           Назначение - <?php  print ($a['note']);?> 
          </div>
<!-- ----------------------------------------------------- -->
<div class="section">
	<ul class="tabs">
